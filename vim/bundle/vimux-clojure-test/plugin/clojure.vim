...
if !exists("g:vimux_clojure_test_cmd")
  let g:vimux_clojure_test_cmd = "lein test"
endif

if !exists("g:vimux_clojure_test_clear_console_on_run")
  let g:vimux_clojure_test_clear_console_on_run = 1
endif
...
function s:RunAllClojureTests()
  ...
  let cmd = g:vimux_clojure_test_cmd . " " . ns

  if g:vimux_clojure_test_clear_console_on_run
    let cmd = "clear && " . cmd
  endif
